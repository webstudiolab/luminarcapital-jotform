...
const cards = [
  ...
  },
  {
    title: 'Flex Line',
    description:
      'We believe in offering financing that is flexible and tailored to your needs. Flex line enables you to quickly access the capital required, instead of committing to a large sum immediately. This cost friendly solution can be utilized on multiple occasions and integrates into your cash flow.',
